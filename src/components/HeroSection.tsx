      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button 
              size="lg"
              className="bg-gradient-gold text-black text-xl px-8 py-6 hover:opacity-90 transform hover:scale-105 transition-all duration-300"
            ...
            <Button 
              variant="outline"
              size="lg"
              className="border-tactical-gold text-tactical-gold hover:bg-tactical-gold hover:text-black text-xl px-8 py-6 transform hover:scale-105 transition-all duration-300"
              onClick={scrollToContact}
            >
              Log In
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="glass-effect p-6 rounded-lg animate-slide-in-right">
              <div className="text-3xl font-bold text-gradient mb-2">250+</div>
              <div className="text-gray-300">Elite Players</div>
            </div>
            <div className="glass-effect p-6 rounded-lg animate-slide-in-right" style={{animationDelay: '0.2s'}}>
              <div className="text-3xl font-bold text-gradient mb-2">40+</div>
              <div className="text-gray-300">Global Leagues</div>
            </div>
            <div className="glass-effect p-6 rounded-lg animate-slide-in-right" style={{animationDelay: '0.4s'}}>
              <div className="text-3xl font-bold text-gradient mb-2">180+</div>
