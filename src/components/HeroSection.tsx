...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-tactical-dark via-tactical-gray to-tactical-dark overflow-hidden mt-10">
